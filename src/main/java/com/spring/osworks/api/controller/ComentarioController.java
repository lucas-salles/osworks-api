...
public class ComentarioController {
	...
	public ComentarioModel addComentario(@PathVariable Long ordemServicoId, @Valid @RequestBody ComentarioInput comentarioInput) {
		Comentario comentario = ordemServicoService.addComentario(ordemServicoId, comentarioInput.getDescricao());
